<footer class="page-footer">
    <div class="container">
        ...
        <p class="border-top mb-0 mt-4 pt-3 small">&copy; <script>document.write(new Date().getFullYear())</script>, J Blog Created By <a href="https://www.devcrud.com" class="text-muted font-weight-bold" target="_blank">Begench.</a>  All rights reserved </p>
    </div>
</footer>
<!-- End of Page Footer -->
