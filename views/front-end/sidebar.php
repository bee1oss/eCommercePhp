<div class="page-sidebar text-center">
    ...
    <figure class="figure mt-5">
        <a href="single-post.php" class="figure-img">
    ...
    <div class="card mb-4">
        <a href="single-post.php" class="overlay-link"></a>
        <div class="card-header p-0">
            <div class="blog-media">
                <img src="../../imgs/blog-6.jpg" alt="" class="w-100">
    ...
    <div class="media text-left mb-4">
        <a href="single-post.php" class="overlay-link"></a>
        <img class="mr-3" src="../../imgs/blog-1.jpg" width="100px" alt="Generic placeholder image">
    ...
    <div class="media text-left mb-4">
        <a href="single-post.php" class="overlay-link"></a>
        <img class="mr-3" src="../../imgs/blog-2.jpg" width="100px" alt="Generic placeholder image">
        <div class="media-body">
    ...
    <div class="media text-left mb-4">
        <a href="single-post.php" class="overlay-link"></a>
        <img class="mr-3" src="../../imgs/blog-3.jpg" width="100px" alt="Generic placeholder image">
        <div class="media-body">
